...
public class SignUpReqDto {
    ...
    @Schema(description = "회원의 비밀번호", example = "1q2w3e4r!Book")
    ...
    @Schema(description = "회원의 비밀번호 확인", example = "1q2w3e4r!Book")
    // 확인용이므로 Pattern 이 아니라, password 와 매치하기만 하면 됨.
    private String checkPassword;


    public User toEntity(String email,String nickname, String password, String image) {
        return User.builder()
                .email(email)
                .nickname(nickname)
                .password(password)
